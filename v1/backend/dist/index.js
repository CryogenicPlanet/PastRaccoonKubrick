...
var require_depd = __commonJS({
  "node_modules/morgan/node_modules/depd/index.js"(exports, module2) {
...
var require_morgan = __commonJS({
  "node_modules/morgan/index.js"(exports, module2) {
    ...
    morgan2.format("dev", function developmentFormatLine(tokens, req, res) {
      ...
      if (!fn) {
        fn = developmentFormatLine[color] = compile("[0m:method :url [" + color + "m:status[0m :response-time ms - :res[content-length][0m");
      }
...
var import_cors = __toModule(require_lib());
var import_express = __toModule(require("express"));
var import_morgan = __toModule(require_morgan());
var app = (0, import_express.default)();
var prisma = new import_client.PrismaClient();
var PROJECT_NAME = "dummyProject";
